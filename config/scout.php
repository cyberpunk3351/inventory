...
return [
    ...
    */
    ...
    | state the host and key credentials for your own Meilisearch instance.
    |
    */
    ...
    'meilisearch' => [
        ...
        'index-settings' => [
            'devices' => [
                'filterableAttributes' => ['device_health', 'health_lifecycle_unit'],
                'searchableAttributes' => ['name'],
                'sortableAttributes' => ['name', 'first_deployed_at'],
            ],
        ],
    ],
